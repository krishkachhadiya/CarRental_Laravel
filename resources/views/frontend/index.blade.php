                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav mx-auto py-0">
                            ...
                            <a href="{{url('my-bookings')}}" class="nav-item nav-link">My Bookings</a>
                    ...
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item">
                            <div class="pb-5">
                                ...
                                <p class="mb-0">“We offer reliable and affordable car rental services with a wide selection of vehicles. Whether you need a car for business or travel, our well-maintained cars ensure comfort, safety, and convenience.”
                                </p>
                            </div>
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                                        ...
                                        <p class="mb-0">“We provide trusted and affordable car rental services for every journey.”</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="about-item-inner border p-4">
                            ...
                            <p class="text-item my-4">“Experience hassle-free car rentals with our wide range of vehicles. Enjoy reliable service, affordable rates, and cars that are safe, clean, and ready for any journey.”
                            </p>
                            <div class="row g-4">
                                <div class="col-lg-6">
        ...
        <div class="container-fluid categories py-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">“Our vehicles are well-maintained, safe, and comfortable, ensuring a smooth and enjoyable ride for every journey.”
                    </p>
                </div>
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            ...
                            <div class="categories-content rounded-bottom p-4">
                                ...
                                <a href="{{url('book')}}"  class="btn btn-primary rounded-pill d-flex justify-content-center py-3">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="categories-item p-4">
        ...
        <div class="container-fluid team py-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">“We provide reliable and efficient car rental services with dedicated customer support. Our team is always ready to assist you, ensuring a smooth and hassle-free experience."
                    </p>
                </div>
                <div class="row g-4">
        ...
        <div class="container-fluid blog py-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                    ...
                    <p class="mb-0">“Stay updated with the latest news and tips in car rentals. From new vehicle arrivals to travel advice, our blog keeps you informed and helps you make the most of your journey.”
                    </p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item">
                            ...
                            <div class="blog-content rounded-bottom p-4">
                                ...
                                <p class="mb-3">“Providing reliable and efficient services, the company ensures customers have a smooth and hassle-free experience. Their team is ready to assist with any questions or needs</p>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item">
                            ...
                            <div class="blog-content rounded-bottom p-4">
                                ...
                                <p class="mb-3">“Customers can easily check the cost of renting a vehicle. Prices are transparent, affordable, and depend on the type of car, rental duration, and any additional services selected."</p>
                                <a href="#" class="">Read More  <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <img src="{{url('frontend/img/blog-3.jpg')}}" class="img-fluid rounded-top w-100" alt="Image">
                            </div>
                            <div class="blog-content rounded-bottom p-4">
                                ...
                                <p class="mb-3">“Customers must provide valid documents to rent a car. This typically includes a driver’s license, a government-issued ID</p>
                                <a href="#" class="">Read More  <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            <div class="footer-item">
                                ...
                                <p class="mb-3">“Providing safe, comfortable, and affordable vehicles for all your travel needs.”</p>
                            </div>
